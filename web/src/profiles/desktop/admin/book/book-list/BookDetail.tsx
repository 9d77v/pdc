            ...
            <div style={{ display: 'flex', height: 320, flexDirection: "column" }}>
                ...
                <div style={{ marginTop: 10, display: 'flex' }}>
                    ...
                    <div style={{ textAlign: "left", paddingLeft: 50 }}>
                        ...
                        <div style={infoStyle}>
                            <span style={itemStyle}>购买价：{book?.purchasePrice}</span>
                        </div>
                        <div style={infoStyle}>
                            <span style={itemStyle}>购买时间：{book?.purchaseTime ? dayjs(book.purchaseTime * 1000).format("YYYY-MM-DD HH:mm:ss") : ""}</span>
                            <span style={itemStyle}>购买途径：{book?.purchaseSource}</span>
                        </div>
                        <div style={infoStyle}>
                            <span style={itemStyle}>创建时间：{book?.purchaseTime ? dayjs(book.createdAt * 1000).format("YYYY-MM-DD HH:mm:ss") : ""}</span>
                            <span style={itemStyle}>更新时间：{book?.purchaseTime ? dayjs(book.createdAt * 1000).format("YYYY-MM-DD HH:mm:ss") : ""}</span>
                        </div>
                    </div>
                </div>
            </div>
