const AppPath = {
    ...
    BOOK: "/app/book",
    BOOK_INDEX: "/app/book/index",
    BOOK_BOOKSHELF_DETAIL: "/app/book/bookshelf",
    BOOK_BOOK_DETAIL: "/app/book/detail",
    UTIL: "/app/util",
...
const AdminPath = {
    ...
    BOOKSHELF_DETAIL: "/admin/book/bookshelf-detail",
    BOOK_DETAIL: "/admin/book/book-detail",
...
const PathDict = new Map<string, string>([
    ...
    [AppPath.BOOK, '图书'],
    [AppPath.BOOK_INDEX, '书籍索引'],
    [AppPath.BOOK_BOOKSHELF_DETAIL, '书架详情'],
    [AppPath.BOOK_BOOK_DETAIL, '书籍详情'],
    [AdminPath.HOME, '首页'],
    ...
    [AdminPath.BOOK_DETAIL, '书籍详情'],
    [AdminPath.BOOKSHELF_LIST, '书架列表'],
    [AdminPath.BOOKSHELF_DETAIL, '书架详情'],
