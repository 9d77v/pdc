...
var permissonMap = map[string][]int{
	...
	"videoSerieses":                  {consts.RoleAdmin, consts.RoleManager, consts.RoleUser, consts.RoleGuest},
	...
	"historyInfo":                    {consts.RoleAdmin, consts.RoleManager, consts.RoleUser, consts.RoleGuest},
